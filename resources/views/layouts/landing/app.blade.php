...
<head>
    ...
    <link rel="stylesheet" href="{{dynamicAsset('assets/landing/assets_new/css/bootstrap.min.css')}}" />
    <link rel="stylesheet" href="{{dynamicAsset('assets/landing/assets_new/css/animate.css')}}" />
    <link rel="stylesheet" href="{{dynamicAsset('assets/landing/assets_new/css/all.min.css')}}" />
    <link rel="stylesheet" href="{{dynamicAsset('assets/landing/assets_new/css/owl.min.css')}}" />
    <link rel="stylesheet" href="{{dynamicAsset('assets/landing/assets_new/css/main.css')}}" />
...
<body>
    ...
    @yield('content')
                ...
                <div class="container">
                    <div class="footer-wrapper ps-xl-5">
                        <div class="footer-widget">
                            ...
                            <div class="txt">
                                {{ isset($landing_data['footer_data']) ? $landing_data['footer_data'] : '' }}
                            </div>
                            ...
                            <div class="app-btn-grp">
                                ...
                                <a href="{{ $landing_page_links['app_url_android'] }}">
                                    <img src="{{dynamicAsset('assets/landing/assets_new/img/google.svg')}}" alt="">
                                </a>
                                @endif
                                @if ($landing_page_links['app_url_ios_status'])
                                <a href="{{ $landing_page_links['app_url_ios'] }}">
                                    <img src="{{dynamicAsset('assets/landing/assets_new/img/apple.svg')}}" alt="">
                                </a>
                                @endif
                            </div>
                            @endif
                        ...
                        <div class="footer-widget widget-links">
                            <h5 class="subtitle mt-2 text-white">{{ translate('messages.Support') }}</h5>
                            <ul>
                    ...
                    <div class="copyright text-center mt-3">
                        ...
                        {{ translate('By') }} {{ \App\CentralLogics\Helpers::get_business_settings('business_name') }}
                    </div>
                </div>
            </div>
        ...
        <script src="{{dynamicAsset('assets/landing/assets_new/js/jquery-3.6.0.min.js')}}"></script>
        <script src="{{dynamicAsset('assets/landing/assets_new/js/bootstrap.min.js')}}"></script>
        <script src="{{dynamicAsset('assets/landing/assets_new/js/viewport.jquery.js')}}"></script>
        <script src="{{dynamicAsset('assets/landing/assets_new/js/wow.min.js')}}"></script>
        <script src="{{dynamicAsset('assets/landing/assets_new/js/owl.min.js')}}"></script>
        <script src="{{dynamicAsset('assets/landing/assets_new/js/main.js')}}"></script>
