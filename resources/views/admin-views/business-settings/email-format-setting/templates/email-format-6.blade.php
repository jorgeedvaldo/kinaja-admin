    ...
    <tbody>
        <tr>
            <td class="main-table-td">
                ...
                <img class="mail-img-2 onerror-image" data-onerror-image="{{ dynamicAsset('assets/admin/img/blank3.png') }}"

                src="{{ $data['icon_full_url'] ?? dynamicAsset('assets/admin/img/blank1.png') }}"
