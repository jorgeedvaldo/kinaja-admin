    ...
    <tbody>
        <tr>
            ...
            <td class="main-table-td">
                <img class="mail-img-1 onerror-image" data-onerror-image="{{ dynamicAsset('assets/admin/img/blank1.png') }}"
                src="{{ $data['logo_full_url'] ?? dynamicAsset('assets/admin/img/blank1.png') }}"
                ...
                <img class="mb-2 mail-img-3 onerror-image" id="bannerViewer" data-onerror-image="{{ dynamicAsset('assets/admin/img/blank2.png') }}"
                src="{{ $data['image_full_url'] ?? dynamicAsset('assets/admin/img/blank1.png') }}"
