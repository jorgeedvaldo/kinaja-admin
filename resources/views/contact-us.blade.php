                            ...
                            <div class="col-lg-4 col-md-10">
                                <div class="contact-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="tel:{{\App\CentralLogics\Helpers::get_business_settings('phone')}}" class="info text-base">{{\App\CentralLogics\Helpers::get_business_settings('phone')}}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-10">
                                <div class="contact-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="mailto:{{\App\CentralLogics\Helpers::get_business_settings('email_address')}}" class="info text-base">{{\App\CentralLogics\Helpers::get_business_settings('email_address')}}</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-10">
                                <div class="contact-item">
                                    ...
                                    <div class="content">
                                        ...
                                        class="info text-base">{{\App\CentralLogics\Helpers::get_business_settings('address')}}
                                    </a>
                                    </div>
                                </div>
                            </div>
