                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img class="landing-initial-1 ratio-2-1" id="coverImageViewer"
                                                         src="{{ dynamicAsset('assets/landing/img/restaurant-cover.png') }}"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img class="landing-initial-1 ratio-1" id="logoImageViewer"
                                                         src="{{ dynamicAsset('assets/landing/img/restaurant-logo.png') }}"
                                                         alt="Product thumbnail" />
                                                </div>
                                                <div class="landing-input-file-grp">
                                                    <label
...
@push('script_2')
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key={{ \App\CentralLogics\Helpers::get_business_settings('map_api_key') }}&libraries=places,marker,geometry&v=3.61&language={{ str_replace('_', '-', app()->getLocale()) }}&callback=initMap"
        async defer>
    </script>
